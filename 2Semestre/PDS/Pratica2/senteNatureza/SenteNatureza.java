...
public class SenteNatureza {
    ...
    private static void test(PrintStream out) {
        ...
        CatologAdmin ctgAdmin = new BaseCatalogAdmin();
    ...
    private static void alineaD(PrintStream out) {
        ...
        CatologAdmin ctgAdmin1 = new BaseCatalogAdmin();
        CatologAdmin ctgAdmin2 = new BaseCatalogAdmin();

        lg.registarServico(ctgAdmin1, "1001", new Alojamento("Camping Serr&Sol - Tenda 1", "Local para tenda, 2 m2", 40, 1));
        lg.registarServico(ctgAdmin1, "1002", new Alojamento("Camping Serr&Sol - Tenda 2", "Local para tenda, 3 m2", 50, 2));
        lg.registarServico(ctgAdmin2, "1003", new Alojamento("Camping Serr&Sol - Tenda 3", "Local para tenda, 5 m2", 70, 3));
