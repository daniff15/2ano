...
public class PrefixCalculatorBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements PrefixCalculatorVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitOperators(PrefixCalculatorParser.OperatorsContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitNumbers(PrefixCalculatorParser.NumbersContext ctx) { return visitChildren(ctx); }
}