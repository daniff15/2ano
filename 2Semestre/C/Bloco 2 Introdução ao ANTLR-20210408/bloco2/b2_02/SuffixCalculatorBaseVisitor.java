...
public class SuffixCalculatorBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SuffixCalculatorVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitNumbers(SuffixCalculatorParser.NumbersContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitOperators(SuffixCalculatorParser.OperatorsContext ctx) { return visitChildren(ctx); }
}